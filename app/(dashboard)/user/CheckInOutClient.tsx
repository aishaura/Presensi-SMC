      ...
      <div className="space-y-2">
        ...
        {imagePreview ? (
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="flex flex-col items-center justify-center h-32 border-2 border-dashed border-slate-200 rounded-2xl cursor-pointer hover:bg-amber-50/40 hover:border-amber-400/80 transition-all group bg-slate-50/50">
              <div className="p-2.5 bg-amber-100/80 text-amber-700 border border-amber-200 rounded-2xl group-hover:scale-105 transition-transform">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
              </div>
              <span className="text-xs font-semibold text-slate-700 mt-2">Ambil Foto</span>
              <input
                type="file"
                accept="image/*"
                capture="environment"
            ...
            <label className="flex flex-col items-center justify-center h-32 border-2 border-dashed border-slate-200 rounded-2xl cursor-pointer hover:bg-blue-50/40 hover:border-blue-400/80 transition-all group bg-slate-50/50">
              <div className="p-2.5 bg-blue-100/80 text-blue-700 border border-blue-200 rounded-2xl group-hover:scale-105 transition-transform">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span className="text-xs font-semibold text-slate-700 mt-2">Pilih Galeri</span>
              <input
                type="file"
                accept="image/*"
                onChange={handleImageChange}
        ...
        <p className="text-[11px] text-slate-400 text-center">PNG, JPG (Maks 5MB)</p>
      </div>
