                ...
                filteredRecords.map((rec) => (
                  <tr key={rec.id} className="hover:bg-gray-50/50">
                    ...
                    <td className="px-6 py-4">
                      ...
                      <div className="text-xs text-gray-700 font-semibold truncate max-w-[180px]" title={rec.check_in_address || ''}>
                        {rec.check_in_address || '-'}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="font-semibold text-gray-900">{formatTime(rec.check_out_time)}</div>
                      <div className="text-xs text-gray-700 font-semibold truncate max-w-[180px]" title={rec.check_out_address || ''}>
